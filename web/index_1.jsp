  ...
  %>
  	...
  	<div class="tm-header">
          ...
          <ul class="dropdown-menu pull-right">
            ...
            <li> <a href="EditProfile.jsp"><i class=" fa fa-user"></i>Edit Profile </a> </li>
								...
								<form action="resultSearch.jsp"  class="hotel-search-form">
									<div class="tm-form-inner">
										<div class="form-group">
							          	...
							          	<div class="form-group">
                                                                            <h>Exemple : 28/05/2018</h>
							                <div class='input-group date' id='datetimepicker1'>
							                   <!-- <input type='text' name="dateA" class="form-control" placeholder="date d'arrivée" /> -->
                                                                            <input type="text" id="date"  name="dateA" value="Date_arrivé" onfocus="if(this.value=='Date_arrivé'){this.value=''};" onblur="if(this.value==''){this.value='Date_arrivé'};"/>
							          	...
							          	<div class="form-group">
							                <div class='input-group date' id='datetimepicker2'>
                                                                             ...
                                                                             <input type="text" id="date" name="dateD" value="Date_départ" onfocus="if(this.value=='Date_départ'){this.value=''};" onblur="if(this.value==''){this.value='Date_départ'};"/>
							                    <!--<input type='text' name="dateD" class="form-control" placeholder="date de départ" />-->
							                    <span class="input-group-addon">
							                        <span class="fa fa-calendar"></span>
							                    </span>
							                </div>
