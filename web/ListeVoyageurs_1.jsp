...
<div id="wrapper">
		...
		ResultSet res1 = ps.executeQuery(sql11);int ii=1;
		 %>
                 <h1 style="color: green" align="center">Selectionner un seul Voyageur</h1>
   <form method="post" action="etat_compteVoyageur">
                          <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <% System.out.println("ani fel jsp listeVoyageur.jsp");
                                    %>
                                     <tr class="success">
