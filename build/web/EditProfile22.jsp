				...
				<form action="EditerPro" method="post" class="tm-contact-form">
					...
					<div class="col-lg-6 col-md-6 tm-contact-form-input">
						<div class="form-group">
							<input type="text" id="contact_name" class="form-control" name="nom" value=<% out.print(session.getAttribute("nom"));%> />
						</div>
						<div class="form-group">
							<input  type="email" id="contact_email" class="form-control" name="mail" value=<%
								out.print(session.getAttribute("mail"));
							%> />
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="pass" value=<% out.print(session.getAttribute("psw")); 
							%> />
						</div>
						<div class="form-group">
