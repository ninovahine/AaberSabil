        ...
        <div id="page-wrapper" >
             <div id="page-inner"> 
                <div class="row">
                    ...
                    <form method="post" action="listeHote"> 
                 <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             <input type="submit" name="button" class="btn btn-primary" value="Activer/Désactiver comptes Hotes" >
                        </div>
                       
                    </div>
                             
       
                        <% System.out.println("ani fel jsp lewla listeHote.jsp");%>
